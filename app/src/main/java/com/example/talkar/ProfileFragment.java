...
//        totalNumbers = getResources().getStringArray(R.array.modelNumber_array).length;
        ...
        int totalLessonCount = totalColors+totalGreetings+totalQuiz+totalSentences+totalShapes+totalWords;
...
//        int numberCount = sharedPreferences.getInt(sp_lesson_number, 0);
        ...
        int lessonCount = shapeCount+colorCount+wordCount+greetingCount+sentenceCount+quizCount;
