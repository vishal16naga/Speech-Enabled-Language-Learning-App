...
public class LessonFragment extends Fragment {
    ...
    private int shapesCompleted, colorsCompleted, wordsCompleted, greetingsCompleted, sentencesCompleted, quizCompleted;
...
//            }
        ...
        colors.setOnClickListener(v -> {
         //   if (numbersCompleted>0 || shapesCompleted>0){
...
//            }
        ...
        words.setOnClickListener(v -> {
          //  if (numbersCompleted>0 || shapesCompleted>0 || colorsCompleted>0){
...
//            }
       ...
       //     if (numbersCompleted>0 || shapesCompleted>0 || colorsCompleted>0 || wordsCompleted>0){
...
//            }
       ...
       //     if (numbersCompleted>0 || shapesCompleted>0 || colorsCompleted>0 || wordsCompleted>0 || greetingsCompleted>0){
...
//            }
      ...
      //      if (numbersCompleted>0 || shapesCompleted>0 || colorsCompleted>0 || wordsCompleted>0 || greetingsCompleted>0 || sentencesCompleted>0){
